...
struct ContentView: View {
    ...
    private let keychainSettingsRepository: SettingsRepository = SettingsRepository(settings: KeychainSettings(service: "Settings Demo", accessibility: KeychainSettings.Accessibility.afterfirstunlock))
    ...
    var body: some View {
        VStack(alignment: .leading) {
            ...
            .padding(.vertical, 8)
            .onChange(of: settingsRepository) { _, newRepository in
                enableLogging = selectedItem().isLoggingEnabled
            }
