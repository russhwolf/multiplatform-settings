...
public actual class PlatformSettings public constructor(private val delegate: NSUserDefaults) : Settings {
     ...
     */
    public actual override fun putInt(key: String, value: Int): Unit = delegate.setObject(value, key)
     ...
     */
    public actual override fun putLong(key: String, value: Long): Unit = delegate.setObject(value, key)
    ...
    public actual override fun getLong(key: String, defaultValue: Long): Long =
        if (hasKey(key)) delegate.objectForKey(key) as Long else defaultValue
