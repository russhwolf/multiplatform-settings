...
commonMain {
    dependencies {
        // ...
        implementation("com.russhwolf:multiplatform-settings:0.7.5")
    }
}
``` 
...
```kotlin
implementation("com.russhwolf:multiplatform-settings-serialization:0.7.5")
```
...
```kotlin
implementation("com.russhwolf:multiplatform-settings-coroutines:0.7.5")

// Or, if you use native-mt coroutines release
implementation("com.russhwolf:multiplatform-settings-coroutines-native-mt:0.7.5")
```
...
```kotlin
implementation("com.russhwolf:multiplatform-settings-datastore:0.7.5")
```
