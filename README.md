...
commonMain {
    dependencies {
        // ...
        implementation("com.russhwolf:multiplatform-settings:0.7.2")
    }
}
``` 
...
```kotlin
implementation("com.russhwolf:multiplatform-settings-no-arg:0.7.2")
```
...
```kotlin
implementation("com.russhwolf:multiplatform-settings-test:0.7.2")
```    
...
```kotlin
implementation("com.russhwolf:multiplatform-settings-serialization:0.7.2")
```
...
implementation("com.russhwolf:multiplatform-settings-coroutines-native-mt:0.7.2")
```
